...
THERMAL_DIFFUSIVITY = (
    THERMAL_CONDUCTIVITY / (DENSITY * SPECIFIC_HEAT_CAPACITY) * 1e-3  # in ms
)
...
# Time
REFERENCE_TIME = 1
dt = 0.49 * dx**2 / ALPHA  # Forward Euler CFL limit (conservative for RK4)
...
# Stability condition (Forward Euler CFL; RK4 allows larger dt but this is a safe bound)
